export const MOCK_RECIPES = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Add amaretto or rum if using",
      "Pour cooled coffee into a shallow dish",
      "Quickly dip each ladyfinger into coffee (don't soak them)",
  ...
  },
  {
    ...
    description: "Fettuccine pasta with creamy Alfredo sauce and grilled chicken. A rich and comforting Italian-American favorite that's easy to make at home.",
    ...
    instructions: [
      ...
      "Gradually whisk in grated Parmesan cheese until smooth and creamy",
      "Season sauce with salt and pepper to taste",
      "Add cooked pasta to the sauce and toss to coat",
      "Add sliced chicken and gently combine",
  ...
  },
  {
    ...
    description: "Stunning red-colored cake with a subtle chocolate flavor, topped with cream cheese frosting. A showstopping dessert for special occasions.",
    image: "https://images.unsplash.com/photo-1586788680434-30d324626f14?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    time: "1 hour",
    servings: 12,
    category: "Desserts",
    ingredients: [
    ...
    instructions: [
      ...
      "In a large bowl, beat oil, buttermilk, eggs, food coloring, vinegar, and vanilla",
      ...
      "Gradually add powdered sugar, vanilla, and salt, beating until creamy",
      "Once cakes are cool, frost between layers, then cover top and sides",
      "Refrigerate cake for at least 1 hour before serving to set the frosting"
    ]
  },
  {
    id: 20,
    title: "Mango Sticky Rice",
    description: "Sweet Thai dessert of glutinous rice cooked in coconut milk and served with fresh mango. A perfect balance of creamy, sweet, and fruity flavors.",
    image: "https://images.unsplash.com/photo-1565538810643-b5bdb714032a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    time: "45 min",
    servings: 4,
    category: "Desserts",
    ingredients: [
      "2 cups glutinous rice (sweet rice), soaked for 4 hours",
    ...
    instructions: [
      "Drain soaked rice and steam for 20-25 minutes until tender",
      "While rice is cooking, in a small saucepan, combine 1 cup coconut milk, 1/2 cup sugar, and salt",
      "Heat until sugar dissolves, but do not boil",
      "When rice is cooked, transfer to a bowl and pour the coconut milk mixture over it",
      "Cover and let sit for 30 minutes to absorb the liquid",
      "For the sauce, heat remaining coconut milk and sugar in a saucepan until slightly thickened",
  ...
  },
  {
    ...
    description: "Japanese-style roll with spicy tuna, cucumber, and avocado. A popular sushi variation that combines fresh fish with a spicy kick.",
    ...
    instructions: [
      "Dice tuna into small cubes and place in a bowl",
      "Mix mayonnaise, sriracha, and sesame oil, then combine with tuna",
      "Place a nori sheet on a bamboo sushi mat, shiny side down",
      "Spread a thin layer of sushi rice over the nori, leaving 1 inch at the top",
      "Sprinkle sesame seeds over the rice",
      "Flip the nori so the rice is facing down on the mat",
      "Place a line of spicy tuna mix, cucumber, and avocado across the center",
      "Roll the sushi tightly, using the mat to apply even pressure",
      "Seal the edge with a few grains of rice or a little water",
      "Use a sharp knife to cut roll into 8 pieces",
